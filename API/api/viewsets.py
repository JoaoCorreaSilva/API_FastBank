...
from App_Fast_Bank.api import serializers
...
class TransacaoViewSet(viewsets.ModelViewSet):
    ...
    # permission_classes = (IsAuthenticated,)
      ...
      def create(self, request, *args, **kwargs):
            ...
            cliente_conta = models.Cliente.objects.filter(conta=numero_da_conta).values("saldo")
            ...
            if  valor_da_transacao < 0 : # significa que será um débito da conta para pagamento de um boleto por exemplo
                ...
                if saldo < (valor_da_transacao * -1): # Multiplicado por -1 para inverter o valor informado e comparar com o saldo disponivel do cliente
                   ...
                   return Response(status=403, data='Não há saldo suficinete para realizar esta transação. ')
            ...
            if _serializer.is_valid():
               ...
               cliente_conta = models.Cliente.objects.get(conta=numero_da_conta)
